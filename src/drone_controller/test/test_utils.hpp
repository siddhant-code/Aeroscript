...
inline std::vector<RVO::Vector3> createTestPositions(int num_drones,
                                                     float spacing = 1.0f) {
...
inline std::vector<RVO::Vector3> createTestGoals(int num_drones,
                                                 float offset = 5.0f) {
...
inline geometry_msgs::msg::PointStamped toPointStamped(const RVO::Vector3& pos,
                                                       int drone_id = 0) {
...
inline bool positionsClose(const RVO::Vector3& pos1, const RVO::Vector3& pos2,
...
inline std::vector<RVO::Vector3> createGridPositions(int rows, int cols,
                                                     float spacing = 1.0f) {
  std::vector<RVO::Vector3> positions;
